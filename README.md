...
5.Copy and paste the rest of the Max Payne 60FPS 1080p patch 6 files: d3d8.dll d3d9.dll d3d9.ini global.ini MaxPayne.WidescreenFix.asi MaxPayne.WidescreenFix.ini into folder 
